    ...
    return (
        ...
        <div>
            ...
            <div className="aboutMe-text-container">
                ...
                <p className="aboutMe-text">I completed courses in these areas, oriented in MERN Stack, including e-commerce projects for FrontEnd and the develop of an RESTful API created for BackEnd, with the implementation of some third party libraries to get more functionality in my projects.</p> 
                ...
                <p className="aboutMe-text">Looking forward to start my professional career to allow myself to gain experience and expand my knowledge, as well as learn new skills and technologies to stay up to date with new and future trends.</p>
            </div>
